...
import { CalendarIcon, Download, BarChart3, PieChart, LineChart, Car, Fuel, Wrench, DollarSign } from "lucide-react"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-green-500/20 to-green-600/20 border-green-500/50">
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-green-500">Fuel Efficiency</p>
                <h3 className="text-3xl font-bold mt-2">
                  24.8 <span className="text-lg">mpg</span>
                </h3>
                <p className="text-sm text-muted-foreground mt-1">+1.2 from last month</p>
              </div>
        ...
        <Card className="bg-gradient-to-br from-orange-500/20 to-orange-600/20 border-orange-500/50">
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-orange-500">Total Expenses</p>
                <h3 className="text-3xl font-bold mt-2">$4,285</h3>
                <p className="text-sm text-muted-foreground mt-1">-$320 from last month</p>
              </div>
        ...
        <TabsContent value="overview" className="space-y-4 mt-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monthly breakdown of vehicle-related expenses</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <CostTrendChart />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Maintenance and repair costs over time</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <MaintenanceChart />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Miles per gallon over time for all vehicles</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                <FuelEfficiencyChart />
        ...
        <TabsContent value="costs" className="space-y-4 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed breakdown of all vehicle-related expenses</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-96">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-medium">$1,845 (43%)</span>
                        </div>
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-medium">$1,250 (29%)</span>
                        </div>
                        <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-medium">$850 (20%)</span>
                        </div>
                        <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
                  ...
                  <div>
                    <h4 className="text-lg font-medium mb-4">Cost Per Vehicle</h4>
                    <div className="space-y-6">
                      <div>
                        <div className="flex justify-between mb-1">
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-medium">$1,190 (28%)</span>
                        </div>
                        <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>How your costs have changed over time</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                <CostTrendChart />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Breakdown of maintenance by type</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-muted">
                      <tr>
                        ...
                        <th className="py-3 px-4 text-left font-medium">Estimated Cost</th>
                    ...
                    <tbody className="divide-y">
                      ...
                      <tr className="hover:bg-muted/50">
                        ...
                        <td className="py-3 px-4">Jun 22, 2023</td>
                      ...
                      <tr className="hover:bg-muted/50">
                        ...
                        <td className="py-3 px-4">Jul 05, 2023</td>
                      ...
                      <tr className="hover:bg-muted/50">
                        <td className="py-3 px-4">Tesla Model 3</td>
                        <td className="py-3 px-4">Annual Service</td>
        ...
        <TabsContent value="comparison" className="space-y-4 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Compare performance metrics across your vehicles</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">N/A (Electric)</span>
                    </div>
                    <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
