...
import { Bell, Shield, Smartphone, Globe, Moon, Sun, UserCog, Lock, Mail, MessageSquare, BellOff } from "lucide-react"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Receive email notifications about your vehicles</p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get reminders about upcoming maintenance</p>
                    </div>
                  </div>
                  <Switch
                    checked={settings.maintenanceReminders}
                    onCheckedChange={() => handleSwitchChange("maintenanceReminders")}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Receive alerts about critical service needs</p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get weekly summary reports of your vehicles</p>
                    </div>
                  </div>
                  <Switch
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-2 pt-2">
                <input
                  ...
                  defaultChecked={true}
                />
                <Label htmlFor="dnd-enabled">Enable Do Not Disturb schedule</Label>
              </div>

              <div className="pt-2">
                <Button variant="outline" onClick={() => handleSaveSettings("do not disturb")}>
                  Save Schedule
                </Button>
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div
                      className={`border rounded-lg p-4 cursor-pointer flex flex-col items-center ${
                        settings.theme === "system" ? "border-primary bg-primary/10" : "border-border"
                      }`}
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    <div
                      className={`border rounded-lg p-3 cursor-pointer flex items-center justify-center ${
                        settings.colorScheme === "blue" ? "border-primary bg-primary/10" : "border-border"
                      }`}
                    ...
                    <div
                      className={`border rounded-lg p-3 cursor-pointer flex items-center justify-center ${
                        settings.colorScheme === "purple" ? "border-primary bg-primary/10" : "border-border"
                      }`}
                    ...
                    <div
                      className={`border rounded-lg p-3 cursor-pointer flex items-center justify-center ${
                        settings.colorScheme === "green" ? "border-primary bg-primary/10" : "border-border"
                      }`}
                    ...
                    <div
                      className={`border rounded-lg p-3 cursor-pointer flex items-center justify-center ${
                        settings.colorScheme === "orange" ? "border-primary bg-primary/10" : "border-border"
                      }`}
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={settings.dataSharing} onCheckedChange={() => handleSwitchChange("dataSharing")} />
                </div>

                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium">Location Tracking</h4>
                    <p className="text-sm text-muted-foreground">Allow location tracking for vehicle services</p>
                  </div>
                  <Switch
                    checked={settings.locationTracking}
                    onCheckedChange={() => handleSwitchChange("locationTracking")}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={settings.analytics} onCheckedChange={() => handleSwitchChange("analytics")} />
                </div>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="account-phone" name="phone" value={settings.phone} onChange={handleInputChange} />
                </div>
                <div className="space-y-2">
